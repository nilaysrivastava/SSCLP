...
if __name__ == '__main__':
    ...
    'dataset1'
    lnc_dis = np.loadtxt("../data/dataset1/lnc_dis_association_new2.txt")  # 240,405,2687
    mi_dis = np.loadtxt("../data/dataset1/mi_dis_association_new2.txt")  # 495,405,13559
    lnc_mi = np.loadtxt("../data/dataset1/lnc_mi_interaction_new2.txt")  # 240,495,1002
    dis_sem_sim = np.loadtxt("../data/dataset1/dis_sem_sim.txt")  # 405,405
    ...
    np.savetxt("../data/dataset1/one_hot_lnc_sim_" + str(a) + str(b) + ".txt", lnc_sim)
    ...
    np.savetxt("../data/dataset1/one_hot_mi_sim_"+str(a) + str(b) +".txt", mi_sim)
    ...
    np.savetxt("../data/dataset1/one_hot_dis_sim_" + str(a) + str(b) + ".txt", dis_sim)
